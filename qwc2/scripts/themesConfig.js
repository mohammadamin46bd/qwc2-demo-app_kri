...
function getTheme(configItem, resultItem) {
    ...
    return new Promise((resolve) => {
        axios.get(getCapabilitiesUrl).then((response) => {
            ...
            //console.log('_______________'+resultItem.crs);
            ...
            //console.log('westSouthDesiredCoordinate__________'+westSouthDesiredCoordinate);
            //console.log('eastNorthDesiredCoordinate__________'+eastNorthDesiredCoordinate);
